...
public class UnityEngine_Vector3IntWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(UnityEngine.Vector3Int), null);
		...
		L.RegFunction("New", _CreateUnityEngine_Vector3Int);
	...
	static int Distance(IntPtr L)
	{
		try
		{
			...
			UnityEngine.Vector3Int arg1 = StackTraits<UnityEngine.Vector3Int>.Check(L, 2);
			float o = UnityEngine.Vector3Int.Distance(arg0, arg1);
	...
	static int Min(IntPtr L)
	{
		try
		{
			...
			UnityEngine.Vector3Int arg0 = StackTraits<UnityEngine.Vector3Int>.Check(L, 1);
			UnityEngine.Vector3Int arg1 = StackTraits<UnityEngine.Vector3Int>.Check(L, 2);
			UnityEngine.Vector3Int o = UnityEngine.Vector3Int.Min(arg0, arg1);
			ToLua.PushValue(L, o);
			return 1;
		}
		catch (Exception e)
	...
	static int Max(IntPtr L)
	{
		try
		{
			...
			UnityEngine.Vector3Int arg0 = StackTraits<UnityEngine.Vector3Int>.Check(L, 1);
			UnityEngine.Vector3Int arg1 = StackTraits<UnityEngine.Vector3Int>.Check(L, 2);
			UnityEngine.Vector3Int o = UnityEngine.Vector3Int.Max(arg0, arg1);
			ToLua.PushValue(L, o);
			return 1;
		}
		catch (Exception e)
	...
	static int Clamp(IntPtr L)
	{
		try
		{
			...
			UnityEngine.Vector3Int obj = (UnityEngine.Vector3Int)ToLua.CheckObject(L, 1, typeof(UnityEngine.Vector3Int));
			UnityEngine.Vector3Int arg0 = StackTraits<UnityEngine.Vector3Int>.Check(L, 2);
			UnityEngine.Vector3Int arg1 = StackTraits<UnityEngine.Vector3Int>.Check(L, 3);
			obj.Clamp(arg0, arg1);
			ToLua.SetBack(L, 1, obj);
			return 0;
		}
	...
	static int FloorToInt(IntPtr L)
	{
		try
		{
			...
			UnityEngine.Vector3Int o = UnityEngine.Vector3Int.FloorToInt(arg0);
			ToLua.PushValue(L, o);
			return 1;
		}
		catch (Exception e)
	...
	static int CeilToInt(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 1);
			UnityEngine.Vector3 arg0 = ToLua.ToVector3(L, 1);
			UnityEngine.Vector3Int o = UnityEngine.Vector3Int.CeilToInt(arg0);
			ToLua.PushValue(L, o);
			return 1;
		}
		catch (Exception e)
	...
	static int op_Multiply(IntPtr L)
	{
		try
		{
			...
			if (count == 2 && TypeChecker.CheckTypes<UnityEngine.Vector3Int, UnityEngine.Vector3Int>(L, 1))
			{
				UnityEngine.Vector3Int arg0 = StackTraits<UnityEngine.Vector3Int>.To(L, 1);
				UnityEngine.Vector3Int arg1 = StackTraits<UnityEngine.Vector3Int>.To(L, 2);
				UnityEngine.Vector3Int o = arg0 * arg1;
				ToLua.PushValue(L, o);
				return 1;
			}
			else if (count == 2 && TypeChecker.CheckTypes<UnityEngine.Vector3Int, int>(L, 1))
			{
				UnityEngine.Vector3Int arg0 = StackTraits<UnityEngine.Vector3Int>.To(L, 1);
			...
			else if (count == 2 && TypeChecker.CheckTypes<int, UnityEngine.Vector3Int>(L, 1))
			{
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: UnityEngine.Vector3Int.op_Multiply");
			}
		}
		catch (Exception e)
		{
	...
	static int get_zero(IntPtr L)
	{
		try
		{
			ToLua.PushValue(L, UnityEngine.Vector3Int.zero);
			return 1;
		}
		catch (Exception e)
		{
	...
	static int get_one(IntPtr L)
	{
		try
		{
			ToLua.PushValue(L, UnityEngine.Vector3Int.one);
			return 1;
		}
		catch (Exception e)
		{
	...
	static int get_up(IntPtr L)
	{
		try
		{
			ToLua.PushValue(L, UnityEngine.Vector3Int.up);
			return 1;
		}
		catch (Exception e)
		{
	...
	static int get_down(IntPtr L)
	{
		try
		{
			ToLua.PushValue(L, UnityEngine.Vector3Int.down);
			return 1;
		}
		catch (Exception e)
		{
	...
	static int get_left(IntPtr L)
	{
		try
		{
			ToLua.PushValue(L, UnityEngine.Vector3Int.left);
			return 1;
		}
		catch (Exception e)
		{
	...
	static int get_right(IntPtr L)
	{
		try
		{
			ToLua.PushValue(L, UnityEngine.Vector3Int.right);
			return 1;
		}
		catch (Exception e)
		{
